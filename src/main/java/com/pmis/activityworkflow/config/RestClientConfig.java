...
public class RestClientConfig {
    ...
    @Bean
    public RestClient eligibilityRestClient(CompletionEligibilityProperties props) {
        return buildClient(props.getConnectTimeoutMs(), props.getReadTimeoutMs());
    }

    @Bean
    public RestClient activityStatusUpdateRestClient(ActivityStatusUpdateProperties props) {
        return buildClient(props.getConnectTimeoutMs(), props.getReadTimeoutMs());
    }

    @Bean
    public RestClient introspectRestClient(IntrospectProperties props) {
        return buildClient(props.getConnectTimeoutMs(), props.getReadTimeoutMs());
    }
