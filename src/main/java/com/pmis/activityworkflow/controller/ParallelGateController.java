...
public class ParallelGateController {
	...
	@PostMapping(value = "/request-division-approval", consumes = MediaType.MULTIPART_FORM_DATA_VALUE)
	...
	public ResponseEntity<RequestDivisionApprovalResult> requestDivisionApproval(
			@RequestPart("body") @Valid RequestDivisionApprovalRequest body,
			@RequestPart(value = "file", required = false) MultipartFile file) {

		return ResponseEntity.ok(approvalRequestService.requestDivisionApproval(body, file));
	}

	@PostMapping(value = "/request-owner-approval", consumes = MediaType.MULTIPART_FORM_DATA_VALUE)
	...
	public ResponseEntity<RequestOwnerApprovalResult> requestOwnerApproval(
			@RequestPart("body") @Valid RequestOwnerApprovalRequest body,
			@RequestPart(value = "file", required = false) MultipartFile file) {
